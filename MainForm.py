...
class Ui_MainForm(object):
    def setupUi(self, MainForm):
        ...
        self.pushButton.clicked.connect(MainForm.analyzeClick) # type: ignore
        self.pushButton_2.clicked.connect(MainForm.clearClick) # type: ignore
        self.pushButton_3.clicked.connect(MainForm.switchSourceClick) # type: ignore
